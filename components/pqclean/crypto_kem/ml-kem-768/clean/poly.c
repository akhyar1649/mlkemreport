...
void PQCLEAN_MLKEM768_CLEAN_poly_basemul_montgomery(poly *r, const poly *a, const poly *b) {
    ...
    for (i = 0; i + 1 < nblocks; i += 2) {
        ...
        int16_t zeta0 = PQCLEAN_MLKEM768_CLEAN_zetas[64 + i];
        int16_t zeta1 = PQCLEAN_MLKEM768_CLEAN_zetas[64 + i + 1];
        ...
        rp0[0] = PQCLEAN_MLKEM768_CLEAN_montgomery_reduce((int32_t)mul0[0] * zeta0) + mul0[3];
        rp0[1] = mul0[2] + mul0[1];
        rp0[2] = PQCLEAN_MLKEM768_CLEAN_montgomery_reduce((int32_t)mul0[4] * zeta0_neg) + mul0[7];
        rp0[3] = mul0[6] + mul0[5];

        rp1[0] = PQCLEAN_MLKEM768_CLEAN_montgomery_reduce((int32_t)mul1[0] * zeta1) + mul1[3];
        rp1[1] = mul1[2] + mul1[1];
        rp1[2] = PQCLEAN_MLKEM768_CLEAN_montgomery_reduce((int32_t)mul1[4] * zeta1_neg) + mul1[7];
        rp1[3] = mul1[6] + mul1[5];
    }
    ...
    if (i < nblocks) {
        ...
        int16_t zeta = PQCLEAN_MLKEM768_CLEAN_zetas[64 + i];
        ...
        r->coeffs[4 * i + 0] = PQCLEAN_MLKEM768_CLEAN_montgomery_reduce((int32_t)mul[0] * zeta) + mul[3];
        r->coeffs[4 * i + 1] = mul[2] + mul[1];
        r->coeffs[4 * i + 2] = PQCLEAN_MLKEM768_CLEAN_montgomery_reduce((int32_t)mul[4] * zeta_neg) + mul[7];
